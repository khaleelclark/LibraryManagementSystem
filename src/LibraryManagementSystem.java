...
public class LibraryManagementSystem {
   private final static List<Patron> patronList = new ArrayList<>();
    ...
    public static void startLMS() {
     while(true){
      ...
      System.out.println("1. Add a Library Patron from a File");
      ...
      switch(scanner.next()) {
       case "1": addPatronFromFile(); break;
       case "2": addPatronManually(); break;
       case "3": removePatron(); break;
       case "4": displayAllPatrons(); break;
       case "5": {
 ...
 public static void addPatronFromFile() {
  ...
  System.out.println("Enter the path of the file you wish to use to load the LMS, without quotations.\nEx. C:\\LibrarySystem\\Data\\Patrons\\patrons_list.txt");
  ...
  displayAllPatrons();
    ...
    public static void addPatronManually() {
     ...
     System.out.println("Id: " + id + " Name: " + name + " Address: " + address + " Fine Amount: " + fineAmount);
